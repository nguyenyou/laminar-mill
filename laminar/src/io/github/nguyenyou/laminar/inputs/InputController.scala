package io.github.nguyenyou.laminar.inputs
...
import io.github.nguyenyou.laminar.keys.{EventProcessor, EventProp, HtmlProp}
import io.github.nguyenyou.laminar.modifiers.{Binder, EventListener, KeyUpdater}
...
class InputController[Ref <: dom.html.Element, A, B](
  ...
  updater: KeyUpdater[ReactiveHtmlElement[Ref], HtmlProp[A, ?], A],
