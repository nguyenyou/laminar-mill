...
trait StyleProps {
  ...
  protected def autoStyle[V](key: String): StyleProp[V] & s.Auto = 
    new StyleProp[V](key) with s.Auto

  protected def colorStyle(key: String): StyleProp[String] & s.Color & u.Color[SS, DSP] = 
    new StyleProp[String](key) with s.Color with u.Color[SS, DSP]

  protected def flexPositionStyle(key: String): StyleProp[String] & s.FlexPosition = 
    new StyleProp[String](key) with s.FlexPosition

  protected def lengthAutoStyle(key: String): StyleProp[String] & s.Auto & u.Length[DSP, Int] = 
    new StyleProp[String](key) with s.Auto with u.Length[DSP, Int]

  protected def lengthStyle(key: String): StyleProp[String] & u.Length[DSP, Int] = 
  ...
  protected def maxLengthStyle(key: String): StyleProp[String] & s.MinMaxLength & s.None = 
    new StyleProp[String](key) with s.MinMaxLength with s.None

  protected def minLengthStyle(key: String): StyleProp[String] & s.MinMaxLength & s.Auto = 
    new StyleProp[String](key) with s.MinMaxLength with s.Auto

  protected def noneStyle[V](key: String): StyleProp[V] & s.None = 
    new StyleProp[V](key) with s.None

  protected def normalStyle[V](key: String): StyleProp[V] & s.Normal = 
    new StyleProp[V](key) with s.Normal

  protected def overflowStyle(key: String): StyleProp[String] & s.Overflow = 
    new StyleProp[String](key) with s.Overflow

  protected def paddingBoxSizingStyle(key: String): StyleProp[String] & s.PaddingBoxSizing = 
    new StyleProp[String](key) with s.PaddingBoxSizing

  protected def pageBreakStyle(key: String): StyleProp[String] & s.PageBreak = 
    new StyleProp[String](key) with s.PageBreak

  protected def textAlignStyle(key: String): StyleProp[String] & s.TextAlign = 
  ...
  protected def urlNoneStyle(key: String): StyleProp[String] & s.None & u.Url[DSP] = 
    new StyleProp[String](key) with s.None with u.Url[DSP]

  protected def urlStyle(key: String): StyleProp[String] & u.Url[DSP] = 
    new StyleProp[String](key) with u.Url[DSP]


  // -- Unique types --

  protected def alignContentStyle(key: String): StyleProp[String] & s.AlignContent = 
    new StyleProp[String](key) with s.AlignContent

  protected def backfaceVisibilityStyle(key: String): StyleProp[String] & s.BackfaceVisibility = 
    new StyleProp[String](key) with s.BackfaceVisibility

  protected def backgroundAttachmentStyle(key: String): StyleProp[String] & s.BackgroundAttachment = 
    new StyleProp[String](key) with s.BackgroundAttachment

  protected def backgroundSizeStyle(key: String): StyleProp[String] & s.BackgroundSize = 
    new StyleProp[String](key) with s.BackgroundSize

  protected def borderCollapseStyle(key: String): StyleProp[String] & s.BorderCollapse = 
    new StyleProp[String](key) with s.BorderCollapse

  protected def boxSizingStyle(key: String): StyleProp[String] & s.BoxSizing = 
    new StyleProp[String](key) with s.BoxSizing

  protected def clearStyle(key: String): StyleProp[String] & s.Clear = 
    new StyleProp[String](key) with s.Clear

  protected def colorUrlStyle(key: String): StyleProp[String] & s.Color & u.Color[SS, DSP] & u.Url[DSP] = 
    new StyleProp[String](key) with s.Color with u.Color[SS, DSP] with u.Url[DSP]

  protected def cursorStyle(key: String): StyleProp[String] & s.Cursor = 
    new StyleProp[String](key) with s.Cursor

  protected def directionStyle(key: String): StyleProp[String] & s.Direction = 
    new StyleProp[String](key) with s.Direction

  protected def displayStyle(key: String): StyleProp[String] & s.Display = 
    new StyleProp[String](key) with s.Display

  protected def emptyCellsStyle(key: String): StyleProp[String] & s.EmptyCells = 
    new StyleProp[String](key) with s.EmptyCells

  protected def flexDirectionStyle(key: String): StyleProp[String] & s.FlexDirection = 
    new StyleProp[String](key) with s.FlexDirection

  protected def flexWrapStyle(key: String): StyleProp[String] & s.FlexWrap = 
    new StyleProp[String](key) with s.FlexWrap

  protected def floatStyle(key: String): StyleProp[String] & s.Float = 
    new StyleProp[String](key) with s.Float

  protected def fontSizeStyle(key: String): StyleProp[String] & s.FontSize = 
    new StyleProp[String](key) with s.FontSize

  protected def fontStyleStyle(key: String): StyleProp[String] & s.FontStyle = 
    new StyleProp[String](key) with s.FontStyle

  protected def fontWeightStyle(key: String): StyleProp[String] & s.FontWeight = 
    new StyleProp[String](key) with s.FontWeight

  protected def justifyContentStyle(key: String): StyleProp[String] & s.JustifyContent = 
    new StyleProp[String](key) with s.JustifyContent

  protected def lengthNormalStyle(key: String): StyleProp[String] & s.Normal & u.Length[DSP, Int] = 
    new StyleProp[String](key) with s.Normal with u.Length[DSP, Int]

  protected def listStylePositionStyle(key: String): StyleProp[String] & s.ListStylePosition = 
    new StyleProp[String](key) with s.ListStylePosition

  protected def listStyleTypeStyle(key: String): StyleProp[String] & s.ListStyleType = 
    new StyleProp[String](key) with s.ListStyleType

  protected def mixBlendModeStyle(key: String): StyleProp[String] & s.MixBlendMode = 
    new StyleProp[String](key) with s.MixBlendMode

  protected def overflowWrapStyle(key: String): StyleProp[String] & s.OverflowWrap = 
    new StyleProp[String](key) with s.OverflowWrap

  protected def pointerEventsStyle(key: String): StyleProp[String] & s.PointerEvents = 
    new StyleProp[String](key) with s.PointerEvents

  protected def positionStyle(key: String): StyleProp[String] & s.Position = 
    new StyleProp[String](key) with s.Position

  protected def tableLayoutStyle(key: String): StyleProp[String] & s.TableLayout = 
    new StyleProp[String](key) with s.TableLayout

  protected def textDecorationStyle(key: String): StyleProp[String] & s.TextDecoration = 
    new StyleProp[String](key) with s.TextDecoration

  protected def textOverflowStyle(key: String): StyleProp[String] & s.TextOverflow = 
    new StyleProp[String](key) with s.TextOverflow

  protected def textTransformStyle(key: String): StyleProp[String] & s.TextTransform = 
    new StyleProp[String](key) with s.TextTransform

  protected def textUnderlinePositionStyle(key: String): StyleProp[String] & s.TextUnderlinePosition = 
    new StyleProp[String](key) with s.TextUnderlinePosition

  protected def verticalAlignStyle(key: String): StyleProp[String] & s.VerticalAlign = 
    new StyleProp[String](key) with s.VerticalAlign

  protected def visibilityStyle(key: String): StyleProp[String] & s.Visibility = 
    new StyleProp[String](key) with s.Visibility

  protected def whiteSpaceStyle(key: String): StyleProp[String] & s.WhiteSpace = 
    new StyleProp[String](key) with s.WhiteSpace

  protected def wordBreakStyle(key: String): StyleProp[String] & s.WordBreak = 
  ...
  /**
    ...
    */
  lazy val animationDelay: StyleProp[String] & u.Time[DSP] = timeStyle("animation-delay")
  ...
  /**
    ...
    */
  lazy val animationDuration: StyleProp[String] & u.Time[DSP] = timeStyle("animation-duration")
  ...
  /**
    ...
    */
  lazy val alignContent: StyleProp[String] & s.AlignContent = alignContentStyle("align-content")
  ...
  /**
    ...
    *  - [[https://css-tricks.com/snippets/css/a-guide-to-flexbox/ Guide to Flexbox @ CSS-Tricks]]
    */
  lazy val alignItems: StyleProp[String] & s.FlexPosition = flexPositionStyle("align-items")
  ...
  /**
    ...
    *  - [[https://css-tricks.com/snippets/css/a-guide-to-flexbox/ Guide to Flexbox @ CSS-Tricks]]
    */
  lazy val alignSelf: StyleProp[String] & s.FlexPosition = flexPositionStyle("align-self")
  ...
  /**
    ...
    */
  lazy val background: StyleProp[String] & s.Color & u.Color[SS, DSP] & u.Url[DSP] = colorUrlStyle("background")
  ...
  /**
    ...
    */
  lazy val backgroundAttachment: StyleProp[String] & s.BackgroundAttachment = backgroundAttachmentStyle("background-attachment")
  ...
  /**
    ...
    */
  lazy val backgroundClip: StyleProp[String] & s.PaddingBoxSizing = paddingBoxSizingStyle("background-clip")
  ...
  /**
    ...
    */
  lazy val backgroundColor: StyleProp[String] & s.Color & u.Color[SS, DSP] = colorStyle("background-color")
  ...
  /**
    ...
    */
  lazy val backgroundImage: StyleProp[String] & u.Url[DSP] = urlStyle("background-image")
  ...
  /**
    ...
    */
  lazy val backgroundOrigin: StyleProp[String] & s.PaddingBoxSizing = paddingBoxSizingStyle("background-origin")
  ...
  /**
    ...
    */
  lazy val backgroundSize: StyleProp[String] & s.BackgroundSize = backgroundSizeStyle("background-size")
  ...
  /**
    ...
    */
  lazy val backfaceVisibility: StyleProp[String] & s.BackfaceVisibility = backfaceVisibilityStyle("backface-visibility")
  ...
  /**
    ...
    */
  lazy val borderColor: StyleProp[String] & s.Color & u.Color[SS, DSP] = colorStyle("border-color")
  ...
  /**
    ...
    */
  lazy val borderTopColor: StyleProp[String] & s.Color & u.Color[SS, DSP] = colorStyle("border-top-color")
  ...
  /**
    ...
    */
  lazy val borderRightColor: StyleProp[String] & s.Color & u.Color[SS, DSP] = colorStyle("border-right-color")
  ...
  /**
    ...
    */
  lazy val borderBottomColor: StyleProp[String] & s.Color & u.Color[SS, DSP] = colorStyle("border-bottom-color")
  ...
  /**
    ...
    */
  lazy val borderLeftColor: StyleProp[String] & s.Color & u.Color[SS, DSP] = colorStyle("border-left-color")
  ...
  /**
    ...
    */
  lazy val borderImage: StyleProp[String] & u.Url[DSP] = urlStyle("border-image")
  ...
  /**
    ...
    */
  lazy val borderStyle: StyleProp[String] & s.Line = lineStyle("border-style")
  ...
  /**
    ...
    */
  lazy val borderTopStyle: StyleProp[String] & s.Line = lineStyle("border-top-style")
  ...
  /**
    ...
    */
  lazy val borderRightStyle: StyleProp[String] & s.Line = lineStyle("border-right-style")
  ...
  /**
    ...
    */
  lazy val borderBottomStyle: StyleProp[String] & s.Line = lineStyle("border-bottom-style")
  ...
  /**
    ...
    */
  lazy val borderLeftStyle: StyleProp[String] & s.Line = lineStyle("border-left-style")
  ...
  /**
    ...
    */
  lazy val borderWidth: StyleProp[String] & u.Length[DSP, Int] = lengthStyle("border-width")
  ...
  /**
    ...
    */
  lazy val borderTopWidth: StyleProp[String] & u.Length[DSP, Int] = lengthStyle("border-top-width")
  ...
  /**
    ...
    */
  lazy val borderRightWidth: StyleProp[String] & u.Length[DSP, Int] = lengthStyle("border-right-width")
  ...
  /**
    ...
    */
  lazy val borderBottomWidth: StyleProp[String] & u.Length[DSP, Int] = lengthStyle("border-bottom-width")
  ...
  /**
    ...
    */
  lazy val borderLeftWidth: StyleProp[String] & u.Length[DSP, Int] = lengthStyle("border-left-width")
  ...
  /**
    ...
    */
  lazy val borderRadius: StyleProp[String] & u.Length[DSP, Int] = lengthStyle("border-radius")
  ...
  /**
    ...
    */
  lazy val borderTopLeftRadius: StyleProp[String] & u.Length[DSP, Int] = lengthStyle("border-top-left-radius")
  ...
  /**
    ...
    */
  lazy val borderTopRightRadius: StyleProp[String] & u.Length[DSP, Int] = lengthStyle("border-top-right-radius")
  ...
  /**
    ...
    */
  lazy val borderBottomRightRadius: StyleProp[String] & u.Length[DSP, Int] = lengthStyle("border-bottom-right-radius")
  ...
  /**
    ...
    */
  lazy val borderBottomLeftRadius: StyleProp[String] & u.Length[DSP, Int] = lengthStyle("border-bottom-left-radius")
  ...
  /**
    ...
    */
  lazy val borderCollapse: StyleProp[String] & s.BorderCollapse = borderCollapseStyle("border-collapse")
  ...
  /**
    ...
    */
  lazy val borderSpacing: StyleProp[String] & u.Length[DSP, Int] = lengthStyle("border-spacing")
  ...
  /**
    ...
    */
  lazy val bottom: StyleProp[String] & s.Auto & u.Length[DSP, Int] = lengthAutoStyle("bottom")
  ...
  /**
    ...
    */
  lazy val boxSizing: StyleProp[String] & s.BoxSizing = boxSizingStyle("box-sizing")
  ...
  /**
    ...
    */
  lazy val clear: StyleProp[String] & s.Clear = clearStyle("clear")
  ...
  /**
    ...
    */
  lazy val color: StyleProp[String] & s.Color & u.Color[SS, DSP] = colorStyle("color")
  ...
  /**
    ...
    */
  lazy val columnCount: StyleProp[Int] & s.Auto = autoStyle("column-count")
  ...
  /**
    ...
    */
  lazy val columnGap: StyleProp[String] & u.Length[DSP, Int] = lengthStyle("column-gap")
  ...
  /**
    ...
    */
  lazy val columnWidth: StyleProp[String] & s.Auto & u.Length[DSP, Int] = lengthAutoStyle("column-width")
  ...
  /**
    ...
    */
  lazy val columnRuleColor: StyleProp[String] & s.Color & u.Color[SS, DSP] = colorStyle("column-rule-color")
  ...
  /**
    ...
    */
  lazy val columnRuleWidth: StyleProp[String] & u.Length[DSP, Int] = lengthStyle("column-rule-width")
  ...
  /**
    ...
    */
  lazy val columnRuleStyle: StyleProp[String] & s.Line = lineStyle("column-rule-style")
  ...
  /**
    ...
    */
  lazy val contentCss: StyleProp[String] & s.None & u.Url[DSP] = urlNoneStyle("content")
  ...
  /**
    ...
    */
  lazy val cursor: StyleProp[String] & s.Cursor = cursorStyle("cursor")
  ...
  /**
    ...
    */
  lazy val direction: StyleProp[String] & s.Direction = directionStyle("direction")
  ...
  /**
    ...
    */
  lazy val display: StyleProp[String] & s.Display = displayStyle("display")
  ...
  /**
    ...
    */
  lazy val emptyCells: StyleProp[String] & s.EmptyCells = emptyCellsStyle("empty-cells")
  ...
  /**
    ...
    *  - [[https://css-tricks.com/snippets/css/a-guide-to-flexbox/ Guide to Flexbox @ CSS-Tricks]]
    */
  lazy val flexBasis: StyleProp[String] & s.Auto & u.Length[DSP, Int] = lengthAutoStyle("flex-basis")
  ...
  /**
    ...
    *  - [[https://css-tricks.com/snippets/css/a-guide-to-flexbox/ Guide to Flexbox @ CSS-Tricks]]
    */
  lazy val flexDirection: StyleProp[String] & s.FlexDirection = flexDirectionStyle("flex-direction")
  ...
  /**
    ...
    *  - [[https://css-tricks.com/snippets/css/a-guide-to-flexbox/ Guide to Flexbox @ CSS-Tricks]]
    */
  lazy val flexWrap: StyleProp[String] & s.FlexWrap = flexWrapStyle("flex-wrap")
  ...
  /**
    ...
    */
  lazy val float: StyleProp[String] & s.Float = floatStyle("float")
  ...
  /**
    ...
    */
  lazy val fontSize: StyleProp[String] & s.FontSize = fontSizeStyle("font-size")
  ...
  /**
    ...
    */
  lazy val fontSizeAdjust: StyleProp[Double] & s.None = noneStyle("font-size-adjust")
  ...
  /**
    ...
    */
  lazy val fontStyle: StyleProp[String] & s.FontStyle = fontStyleStyle("font-style")
  ...
  /**
    ...
    */
  lazy val fontWeight: StyleProp[String] & s.FontWeight = fontWeightStyle("font-weight")
  ...
  /**
    ...
    *  - [[https://css-tricks.com/snippets/css/a-guide-to-flexbox/#aa-gap-row-gap-column-gap Guide to Flexbox @ CSS-Tricks]]
    */
  lazy val gap: StyleProp[String] & u.Length[DSP, Int] = lengthStyle("gap")
  ...
  /**
    ...
    */
  lazy val height: StyleProp[String] & s.Auto & u.Length[DSP, Int] = lengthAutoStyle("height")
  ...
  /**
    ...
    */
  lazy val isolation: StyleProp[String] & s.Auto = autoStyle("isolation")
  ...
  /**
    ...
    *  - [[https://css-tricks.com/snippets/css/a-guide-to-flexbox/ Guide to Flexbox @ CSS-Tricks]]
    */
  lazy val justifyContent: StyleProp[String] & s.JustifyContent = justifyContentStyle("justify-content")
  ...
  /**
    ...
    */
  lazy val left: StyleProp[String] & s.Auto & u.Length[DSP, Int] = lengthAutoStyle("left")
  ...
  /**
    ...
    */
  lazy val letterSpacing: StyleProp[String] & s.Normal = normalStyle("letter-spacing")
  ...
  /**
    ...
    */
  lazy val lineHeight: StyleProp[String] & s.Normal & u.Length[DSP, Int] = lengthNormalStyle("line-height")
  ...
  /**
    ...
    */
  lazy val listStyleImage: StyleProp[String] & s.None & u.Url[DSP] = urlNoneStyle("list-style-image")
  ...
  /**
    ...
    */
  lazy val listStylePosition: StyleProp[String] & s.ListStylePosition = listStylePositionStyle("list-style-position")
  ...
  /**
    ...
    */
  lazy val listStyleType: StyleProp[String] & s.ListStyleType = listStyleTypeStyle("list-style-type")
  ...
  /**
    ...
    */
  lazy val margin: StyleProp[String] & s.Auto & u.Length[DSP, Int] = lengthAutoStyle("margin")
  ...
  /**
    ...
    */
  lazy val marginTop: StyleProp[String] & s.Auto & u.Length[DSP, Int] = lengthAutoStyle("margin-top")
  ...
  /**
    ...
    */
  lazy val marginRight: StyleProp[String] & s.Auto & u.Length[DSP, Int] = lengthAutoStyle("margin-right")
  ...
  /**
    ...
    */
  lazy val marginBottom: StyleProp[String] & s.Auto & u.Length[DSP, Int] = lengthAutoStyle("margin-bottom")
  ...
  /**
    ...
    */
  lazy val marginLeft: StyleProp[String] & s.Auto & u.Length[DSP, Int] = lengthAutoStyle("margin-left")
  ...
  /**
    ...
    */
  lazy val mask: StyleProp[String] & s.None & u.Url[DSP] = urlNoneStyle("mask")
  ...
  /**
    ...
    */
  lazy val maxHeight: StyleProp[String] & s.MinMaxLength & s.None = maxLengthStyle("max-height")
  ...
  /**
    ...
    */
  lazy val maxWidth: StyleProp[String] & s.MinMaxLength & s.None = maxLengthStyle("max-width")
  ...
  /**
    ...
    */
  lazy val minHeight: StyleProp[String] & s.MinMaxLength & s.Auto = minLengthStyle("min-height")
  ...
  /**
    ...
    */
  lazy val minWidth: StyleProp[String] & s.MinMaxLength & s.Auto = minLengthStyle("min-width")
  ...
  /**
    ...
    */
  lazy val mixBlendMode: StyleProp[String] & s.MixBlendMode = mixBlendModeStyle("mix-blend-mode")
  ...
  /**
    ...
    */
  lazy val outlineStyle: StyleProp[String] & s.Line = lineStyle("outline-style")
  ...
  /**
    ...
    */
  lazy val outlineWidth: StyleProp[String] & u.Length[DSP, Int] = lengthStyle("outline-width")
  ...
  /**
    ...
    */
  lazy val outlineColor: StyleProp[String] & s.Color & u.Color[SS, DSP] = colorStyle("outline-color")
  ...
  /**
    ...
    */
  lazy val overflow: StyleProp[String] & s.Overflow = overflowStyle("overflow")
  ...
  /**
    ...
    */
  lazy val overflowX: StyleProp[String] & s.Overflow = overflowStyle("overflow-x")
  ...
  /**
    ...
    */
  lazy val overflowY: StyleProp[String] & s.Overflow = overflowStyle("overflow-y")
  ...
  /**
    ...
    */
  lazy val overflowWrap: StyleProp[String] & s.OverflowWrap = overflowWrapStyle("overflow-wrap")


  lazy val wordWrap: StyleProp[String] & s.OverflowWrap = overflowWrap
  ...
  /**
    ...
    */
  lazy val padding: StyleProp[String] & u.Length[DSP, Int] = lengthStyle("padding")
  ...
  /**
    ...
    */
  lazy val paddingTop: StyleProp[String] & u.Length[DSP, Int] = lengthStyle("padding-top")
  ...
  /**
    ...
    */
  lazy val paddingRight: StyleProp[String] & u.Length[DSP, Int] = lengthStyle("padding-right")
  ...
  /**
    ...
    */
  lazy val paddingBottom: StyleProp[String] & u.Length[DSP, Int] = lengthStyle("padding-bottom")
  ...
  /**
    ...
    */
  lazy val paddingLeft: StyleProp[String] & u.Length[DSP, Int] = lengthStyle("padding-left")
  ...
  /**
    ...
    */
  lazy val pageBreakAfter: StyleProp[String] & s.PageBreak = pageBreakStyle("page-break-after")
  ...
  /**
    ...
    */
  lazy val pageBreakBefore: StyleProp[String] & s.PageBreak = pageBreakStyle("page-break-before")
  ...
  /**
    ...
    */
  lazy val pageBreakInside: StyleProp[String] & s.PageBreak = pageBreakStyle("page-break-inside")
  ...
  /**
    ...
    */
  lazy val perspective: StyleProp[String] & s.None = noneStyle("perspective")
  ...
  /**
    ...
    */
  lazy val pointerEvents: StyleProp[String] & s.PointerEvents = pointerEventsStyle("pointer-events")
  ...
  /**
    ...
    */
  lazy val position: StyleProp[String] & s.Position = positionStyle("position")
  ...
  /**
    ...
    */
  lazy val right: StyleProp[String] & s.Auto & u.Length[DSP, Int] = lengthAutoStyle("right")
  ...
  /**
    ...
    */
  lazy val scrollMarginTop: StyleProp[String] & u.Length[DSP, Int] = lengthStyle("scroll-margin-top")
  ...
  /**
    ...
    *  - [[https://css-tricks.com/snippets/css/a-guide-to-flexbox/#aa-gap-row-gap-column-gap Guide to Flexbox @ CSS-Tricks]]
    */
  lazy val rowGap: StyleProp[String] & u.Length[DSP, Int] = lengthStyle("row-gap")
  ...
  /**
    ...
    */
  lazy val tableLayout: StyleProp[String] & s.TableLayout = tableLayoutStyle("table-layout")
  ...
  /**
    ...
    */
  lazy val textAlign: StyleProp[String] & s.TextAlign = textAlignStyle("text-align")
  ...
  /**
    ...
    */
  lazy val textAlignLast: StyleProp[String] & s.TextAlign = textAlignStyle("text-align-last")
  ...
  /**
    ...
    */
  lazy val textDecoration: StyleProp[String] & s.TextDecoration = textDecorationStyle("text-decoration")
  ...
  /**
    ...
    */
  lazy val textOverflow: StyleProp[String] & s.TextOverflow = textOverflowStyle("text-overflow")
  ...
  /**
    ...
    */
  lazy val textShadow: StyleProp[String] & s.None = noneStyle("text-shadow")
  ...
  /**
    ...
    */
  lazy val textTransform: StyleProp[String] & s.TextTransform = textTransformStyle("text-transform")
  ...
  /**
    ...
    */
  lazy val textUnderlinePosition: StyleProp[String] & s.TextUnderlinePosition = textUnderlinePositionStyle("text-underline-position")
  ...
  /**
    ...
    */
  lazy val top: StyleProp[String] & s.Auto & u.Length[DSP, Int] = lengthAutoStyle("top")
  ...
  /**
    ...
    */
  lazy val transitionDelay: StyleProp[String] & u.Time[DSP] = timeStyle("transition-delay")
  ...
  /**
    ...
    */
  lazy val transitionDuration: StyleProp[String] & u.Time[DSP] = timeStyle("transition-duration")
  ...
  /**
    ...
    */
  lazy val verticalAlign: StyleProp[String] & s.VerticalAlign = verticalAlignStyle("vertical-align")
  ...
  /**
    ...
    */
  lazy val visibility: StyleProp[String] & s.Visibility = visibilityStyle("visibility")
  ...
  /**
    ...
    */
  lazy val width: StyleProp[String] & s.Auto & u.Length[DSP, Int] = lengthAutoStyle("width")
  ...
  /**
    ...
    */
  lazy val whiteSpace: StyleProp[String] & s.WhiteSpace = whiteSpaceStyle("white-space")
  ...
  /**
    ...
    */
  lazy val wordBreak: StyleProp[String] & s.WordBreak = wordBreakStyle("word-break")
  ...
  /**
    ...
    */
  lazy val wordSpacing: StyleProp[String] & s.Normal = normalStyle("word-spacing")
  ...
  /**
    ...
    */
  lazy val zIndex: StyleProp[Int] & s.Auto = autoStyle("z-index")
