package io.github.nguyenyou.laminar.defs.props

import io.github.nguyenyou.laminar.keys.HtmlProp
import io.github.nguyenyou.laminar.codecs._
...
trait HtmlProps {
  ...
  /**
    ...
    */
  lazy val crossOrigin: HtmlProp[String, String] = stringProp("crossOrigin")
