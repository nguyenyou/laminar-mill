...
class JsMap[K, V]() extends JsIterable[js.Tuple2[K, V]] {
  ...
  /** !! Not supported by IE !! */
  def keys(): JsIterable[K] & js.Iterator[K] = js.native

  /** !! Not supported by IE !! */
  def values(): JsIterable[V] & js.Iterator[V] = js.native

  /** !! Not supported by IE !! */
  def entries(): JsIterable[js.Tuple2[K, V]] & js.Iterator[js.Tuple2[K, V]] = js.native
