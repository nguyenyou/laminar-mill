...
import io.github.nguyenyou.ew.JsArray.rawJsArray
...
class JsVector[+A] extends JsIterable[A] {
  ...
  /**
    ...
    */
  def concat[B >: A](items: (JsArray[? <: B] | JsVector[? <: B] | js.Array[? <: B])*): JsVector[B] = js.native
...
object JsVector {
  ...
  /**
    ...
    */
  def apply[A](items: A*): JsVector[A] = js.Array(items*).asInstanceOf[JsVector[A]]
