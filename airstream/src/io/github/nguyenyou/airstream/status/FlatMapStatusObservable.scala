...
import io.github.nguyenyou.airstream.core.{BaseObservable, EventStream, Observable}
...
object FlatMapStatusObservable {
  ...
  def apply[A, B, Self[+_] <: Observable[?]](
    ...
    val parentObservable = parent.asInstanceOf[Observable[A] & BaseObservable[Self, A]]
