...
import io.github.nguyenyou.airstream.combine.generated.{
  CombinableSignal,
...
import io.github.nguyenyou.airstream.debug.{
  DebuggableSignal,
  Debugger,
  DebuggerSignal
}
...
import io.github.nguyenyou.airstream.misc.{
  MapSignal,
  ScanLeftSignal,
  StreamFromSignal
}
...
trait Signal[+A]
  ...
  /** See also debug methods in
    * [[io.github.nguyenyou.airstream.debug.DebuggableObservable]]
    */
