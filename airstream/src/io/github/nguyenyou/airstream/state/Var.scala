...
import io.github.nguyenyou.airstream.core.{AirstreamError, Named, Observer, Signal, Sink, Transaction}
import io.github.nguyenyou.airstream.core.AirstreamError.VarError
import io.github.nguyenyou.airstream.core.Source.SignalSource
import io.github.nguyenyou.airstream.extensions.OptionVar
import io.github.nguyenyou.airstream.ownership.Owner
import io.github.nguyenyou.airstream.split.SplittableVar
...
trait Var[A] extends SignalSource[A] with Sink[A] with Named {
  ...
  private[state] def underlyingVar: SourceVar[?]
