...
import io.github.nguyenyou.airstream.core.{BaseObservable, Observable, Protected}
import io.github.nguyenyou.airstream.util.always
...
/** This implicit class provides debug* methods for observables, e.g.:
  ...
  * not be noticeable.
  */
class DebuggableObservable[Self[+_] <: Observable[?], +A](val observable: BaseObservable[Self, A]) {
