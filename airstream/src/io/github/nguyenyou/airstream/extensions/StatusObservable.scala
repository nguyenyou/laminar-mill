...
import io.github.nguyenyou.airstream.status.{Pending, Resolved, Status}

class StatusObservable[In, Out, Self[+_] <: Observable[?]](val observable: BaseObservable[Self, Status[In, Out]]) extends AnyVal {
