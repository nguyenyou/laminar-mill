...
import io.github.nguyenyou.airstream.core.{BaseObservable, EventStream, Observable, Signal}

/** See also: [[OptionStream]] */
class OptionObservable[A, Self[+_] <: Observable[?]](val observable: BaseObservable[Self, Option[A]]) extends AnyVal {
