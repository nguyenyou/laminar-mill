...
import io.github.nguyenyou.airstream.core.{EventStream, InternalObserver, Protected, Signal, Transaction, WritableStream}
...
class SwitchSignalStream[A](
  ...
  private var lastSeenSignalUpdateId: Int = 0
