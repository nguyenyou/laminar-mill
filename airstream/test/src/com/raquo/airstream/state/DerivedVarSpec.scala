...
import io.github.nguyenyou.airstream.core.{AirstreamError, Observer}
...
class DerivedVarSpec extends UnitSpec with BeforeAndAfter {
  ...
  it("strict updates") {
    ...
    val s = Var(Form(10))
    val d = s.zoom(_.int)((form, int) => form.copy(int = int))(using owner)
  ...
  it("laziness, updates and errors") {
    ...
    val s = Var(Form(10))
    val d = s.zoom(_.int)((f, int) => f.copy(int = int))(using varOwner)
  ...
  it("signal does not glitch") {
    ...
    val s = Var(Form(1))
    val d = s.zoom(_.int)((f, v) => f.copy(int = v))(using owner)
  ...
  it("asymmetric derived vars") {
    ...
    val s = Var(Form(10))
    val d1 = s.zoom(_.int)((f, int) => f.copy(int = 100 + int))(using varOwner)
    val d2 = s.zoom(_.int + 100)((f, int) => f.copy(int = int))(using varOwner)
